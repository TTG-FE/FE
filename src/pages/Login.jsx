  ...
  return (
    <div className="flex items-center h-screen ">
      ...
      <div className="mx-auto p-4 sm:p-0">
        <div className=" mr-[31.75rem] sm:text-[2.1875rem] text-[1.rem] font-semibold mb-4">
          간편 로그인 후 <br />
          이용 가능합니다.
        </div>

        <div className="mr-[19.38rem] whitespace-nowrap w-[32.125rem] h-[1.3125rem] sm:text-[1.125rem] text-[0.7rem] text-gray-700 mb-[3.245rem] opacity-50">
        ...
        <NaverLogin
          ...
          render={(props) => (
            <button
              className="mr-[20.06rem]  mb-[1.19rem] flex items-center bg-[#57BC63] rounded-md sm:h-[4.125rem] sm:w-[32.0625rem] w-[21.4375rem] h-[3rem]"
        ...
        />
        <button className="mr-[20.06rem] flex items-center bg-[#FFD600] rounded-md  sm:h-[4.125rem] sm:w-[32.0625rem] w-[21.4375rem] h-[3rem]">
          <svg
            style={{ marginRight: "5.44rem" }}
            className="ml-[3rem]"
            width="42"
