...
const Hot = ({ hotStores }) => {
  ...
  return (
    <div className="md:mb-16">
      ...
      <div className="relative py-10 bg-white md:pl-6 md:py-6 lg:px-16 md:bg-custom-gradation ">
        <div className="flex flex-col max-w-screen-xl md:mx-auto md:flex-row">
          {/* 텍스트 부분 w = 1/3 */}
